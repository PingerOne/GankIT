...
public class RealmHelper {
    ...
    public static final String DB_NAME = "gankit.realm";
    ...
    public void insertSearchHistory(SearchKey bean) {
        //如果有不保存
        List<SearchKey> list = getSearchHistoryList(bean.searchKey);
        ...
        if (listAll != null && listAll.size() >= 10) {
            deleteSearchHistoryList(listAll.get(listAll.size() - 1).searchKey);
        }
    }
