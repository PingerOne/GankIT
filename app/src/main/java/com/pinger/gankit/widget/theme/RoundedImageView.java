package com.pinger.gankit.widget.theme;
...
import com.pinger.gankit.widget.theme.ColorUiInterface;
import com.pinger.gankit.widget.theme.ViewAttributeUtil;

/*
 *  @项目名：  GankIT 
 *  @包名：    com.pinger.gankit.widget
 *  @文件名:   RoundedImageView
 *  @创建者:   Pinger
 *  @创建时间:  2016/11/5 23:59
 *  @描述：    随机图片
 */
